...
if (mode === 'restore') {
  console.log('[google-maps-config] Google Maps placeholders restored in native build files and runtime env.');
} else {
  console.log('[google-maps-config] Google Maps API key injected into native build files and runtime env.');
}
