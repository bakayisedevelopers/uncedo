...
if (!fs.existsSync(target)) {
  console.warn(`[fix-expo-modules-core-cpp-runtime] Missing file: ${target}`);
  process.exit(0);
}
...
console.log('[fix-expo-modules-core-cpp-runtime] Patched expo-modules-core Android CMakeLists.txt');
