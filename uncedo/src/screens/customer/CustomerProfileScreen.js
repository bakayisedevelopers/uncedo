    ...
    <ScrollView contentContainerStyle={styles.wrap} showsVerticalScrollIndicator={false}>
      ...
      <View style={styles.identityCard}>
        ...
        <View style={styles.statusPill}>
          <Ionicons color={onboardingStatus.complete ? '#047857' : '#b45309'} name={onboardingStatus.complete ? 'checkmark-circle' : 'alert-circle'} size={16} />
      ...
      {!onboardingStatus.complete ? (
        <ProfileRow
          ...
          description="Finish onboarding and add a payment method before using the app fully."
