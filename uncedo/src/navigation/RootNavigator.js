...
export function RootNavigator() {
  ...
  const showBottomNav = bottomNavVisible && !['CustomerServiceCall', 'ServiceRequestTracking', 'JobRequestThread', 'SessionRoom', 'ServiceRequestDetails'].includes(activeRoute.key);
