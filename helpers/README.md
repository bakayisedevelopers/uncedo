...
- Firestore-backed service browsing, skill setup, and service approval flow
...
- The helper service catalog is loaded from the shared `serviceCatalog` collection and helper submissions stay pending until the admin approves them.
