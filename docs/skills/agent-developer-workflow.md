...
3. Copy the output APK to the `releases` folder:
   ```powershell
   Copy-Item -Path "app/build/outputs/apk/release/app-release.apk" -Destination "../../releases/android/uncedo-release.apk" -Force
   ```
...
3. Copy the output APK to the `releases` folder:
   ```powershell
   Copy-Item -Path "app/build/outputs/apk/release/app-release.apk" -Destination "../../releases/android/helpers-release.apk" -Force
   ```

---

## 3. Git Pruning and Push (Max 30 Commits)
